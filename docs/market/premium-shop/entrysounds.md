...
<!-- Background image layer cu BLUR si PARALLAX -->
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 5px; font-size: 12px; color: var(--wf-gray); flex-wrap: wrap; opacity: 0.9;">
  <div style="display: flex; align-items: center; gap: 5px;">
    ...
    <a href="/market/payment-methods" style="color: var(--wf-orange); text-decoration: none;">Market</a>
    <span style="color: var(--wf-orange);">/</span>
    <a href="/market/premium-shop/mvp" style="color: var(--wf-orange); text-decoration: none;">Premium Shop</a>
    <span style="color: var(--wf-orange);">/</span>
    <span style="color: #e0e0e0;">Entry Sounds</span>
  </div>
  
  <div style="display: flex; align-items: center; gap: 6px;">
    <img src="/icons/introduction.svg" alt="introduction" class="nav-icon" style="width: 18px; height: 18px;">
    <span style="font-size: 12px; color: var(--wf-gray);">Market</span>
  </div>
</div>
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; border-top: 1px solid rgba(255,69,0,0.2); padding-top: 15px; margin-top: 5px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
    ...
    <PageTagYellow style="font-size: 11px; padding: 2px 8px;">market</PageTagYellow>
    <PageTagGreen style="font-size: 11px; padding: 2px 8px;">sounds</PageTagGreen>
    <PageTagYellow style="font-size: 11px; padding: 2px 8px;">premium</PageTagYellow>
  </div>
  ...
  <div style="display: flex; align-items: center; gap: 6px;">
    ...
    <a 
      ...
      title="iannc69"
    >
      <img src="https://github.com/iannc69.png" alt="iannc69" style="width: 22px; height: 22px; border-radius: 50%; border: 2px solid #1a1a1a; display: block;">
    </a>
  </div>
