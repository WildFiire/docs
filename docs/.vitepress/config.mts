...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', {
      ...
      content: "default-src 'self' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com https://translate.google.com https://translate.googleapis.com https://translate-pa.googleapis.com https://www.gstatic.com; connect-src 'self' https://api.iconify.design https://api.github.com https://discord.com https://*.wildfire.ro wss://*.wildfire.ro https://api.steampowered.com https://community.akamai.steamstatic.com https://raw.githubusercontent.com https://*.githubusercontent.com https://avatar-cyan.vercel.app https://cdn.discordapp.com https://translate.googleapis.com https://translate-pa.googleapis.com; img-src 'self' data: blob: https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://translate.googleapis.com https://translate-pa.googleapis.com https://www.gstatic.com; font-src 'self' https://fonts.gstatic.com;"
    }],
