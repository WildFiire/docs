...
.wch-crumb--active { color: rgba(var(--wf-accent-rgb), 0.9); font-weight: 600; }
...
.wch-meta {
  ...
  padding-top: 18px;
  border-top: 1px solid rgba(var(--wf-accent-rgb), 0.12);
}
.wch-meta-chip {
...
.wch-author-pfp { border-radius: 50%; box-shadow: 0 0 0 2px rgba(var(--wf-accent-rgb), 0.25); }
