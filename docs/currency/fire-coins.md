...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 5px; font-size: 12px; color: var(--vp-c-text-2); flex-wrap: wrap; opacity: 0.9;">
  <div style="display: flex; align-items: center; gap: 5px;">
    ...
    <span style="color: var(--vp-c-brand-1);">/</span>
    <span style="color: var(--vp-c-text-2);" class="orbitron-font">Phoenix Coins</span>
  </div>
  
  <div style="display: flex; align-items: center; gap: 6px;">
    <Icon icon="lucide:coins" :size="18" />
    <span style="font-size: 12px; color: var(--vp-c-text-2);" class="orbitron-font">Credits</span>
  </div>
</div>
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; border-top: 1px solid rgba(255,69,0,0.2); padding-top: 15px; margin-top: 5px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
    ...
    <PageTagRed style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">credite</PageTagRed>
    <PageTagBlue style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">market</PageTagBlue>
    <PageTagGreen style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">skinuri</PageTagGreen>
    <PageTagPurple style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">economie</PageTagPurple>
  </div>
