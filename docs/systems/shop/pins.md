...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 5px; font-size: 12px; color: var(--wf-gray); flex-wrap: wrap; opacity: 0.9;">
  <div style="display: flex; align-items: center; gap: 5px;">
    ...
    <a href="/systems/skins/cases" style="color: var(--wf-orange); text-decoration: none;">Systems</a>
    <span style="color: var(--wf-orange);">/</span>
    <a href="/systems/shop/trails" style="color: var(--wf-orange); text-decoration: none;">Shop</a>
    <span style="color: var(--wf-orange);">/</span>
    <span style="color: #e0e0e0;">Pins</span>
  </div>
  
  <div style="display: flex; align-items: center; gap: 6px;">
    <img src="/icons/introduction.svg" alt="introduction" class="nav-icon" style="width: 18px; height: 18px;">
    <span style="font-size: 12px; color: var(--wf-gray);">Systems</span>
  </div>
</div>
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; border-top: 1px solid rgba(255,69,0,0.2); padding-top: 15px; margin-top: 5px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
    ...
    <PageTagYellow style="font-size: 11px; padding: 2px 8px;">shop</PageTagYellow>
    <PageTagOrange style="font-size: 11px; padding: 2px 8px;">pins</PageTagOrange>
    <PageTagPurple style="font-size: 11px; padding: 2px 8px;">badges</PageTagPurple>
  </div>
