...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 5px; font-size: 12px; color: var(--wf-gray); flex-wrap: wrap; opacity: 0.9;">
  <div style="display: flex; align-items: center; gap: 5px;">
    ...
    <span style="color: var(--wf-orange);">/</span>
    <a href="/systems/gambling/roulette" style="color: var(--wf-orange); text-decoration: none;">Gambling</a>
    <span style="color: var(--wf-orange);">/</span>
    <span style="color: #e0e0e0;">Blackjack</span>
  </div>
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; border-top: 1px solid rgba(255,69,0,0.2); padding-top: 15px; margin-top: 5px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
    ...
    <PageTagRed style="font-size: 11px; padding: 2px 8px;">gambling</PageTagRed>
    <PageTagPurple style="font-size: 11px; padding: 2px 8px;">blackjack</PageTagPurple>
    <PageTagBlue style="font-size: 11px; padding: 2px 8px;">games</PageTagBlue>
  </div>
