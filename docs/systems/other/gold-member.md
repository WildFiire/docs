  ...
  <div style="position: relative; z-index: 1; padding: 30px 30px 20px 30px; border-radius: 24px;">
    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 5px; font-size: 12px; color: var(--vp-c-text-2); flex-wrap: wrap; opacity: 0.9;">
      <div style="display: flex; align-items: center; gap: 5px;">
        ...
        <span style="color: var(--vp-c-brand-1);">/</span>
        <span style="color: var(--vp-c-brand-1);" class="orbitron-font">Other</span>
        <span style="color: var(--vp-c-brand-1);">/</span>
        <span style="color: var(--vp-c-text-2);" class="orbitron-font">Gold Member</span>
      </div>
      <div style="display: flex; align-items: center; gap: 6px;">
        <Icon icon="lucide:crown" :size="18" />
        <span style="font-size: 12px; color: var(--vp-c-text-2);" class="orbitron-font">Gold Member</span>
      </div>
    </div>
    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
      <img src="/icons/wildfire.webp" alt="Wildfire.ro" width="60" style="margin: 0; filter: var(--logo-filter, none);">
      <h1 style="font-size: 32px; margin: 0; color: #ff8c00; font-weight: 700;" class="orbitron-font">Gold Member</h1>
    </div>
    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; border-top: 1px solid rgba(255,69,0,0.2); padding-top: 15px; margin-top: 5px;">
      <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
        ...
        <PageTagPurple style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">systems</PageTagPurple>
        <PageTagYellow style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">gold</PageTagYellow>
        <PageTagYellow style="font-size: 11px; padding: 2px 8px;" class="orbitron-font">premium</PageTagYellow>
      </div>
      <div style="display: flex; align-items: center; gap: 6px;">
